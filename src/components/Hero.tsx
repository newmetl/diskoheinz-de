      ...
      <div className="relative z-10 text-center px-6 max-w-4xl">
        ...
        >
          <div className="relative group">
            {/* Neon ring glow */}
            <div className="absolute -inset-3 rounded-full bg-gradient-to-br from-secondary/30 via-tertiary-fixed-dim/20 to-secondary/30 blur-xl opacity-70 group-hover:opacity-100 transition-opacity duration-700" />
            {/* Outer ring */}
            <div className="absolute -inset-[2px] rounded-full bg-gradient-to-b from-white/20 via-secondary/20 to-tertiary-fixed-dim/20" />
            {/* Image */}
